...
def list(request):
    ...
    context = start_view(request, app="user", view="group_list", 
        noauth="app_home:index", perm="p_group_view", noauthz="app_sirene:index")
    if context["redirect"]:
...
def detail(request, gid=None, gname=None):
    ...
    context = start_view(request, app="user", view="group_detail", 
        noauth="app_user:private", perm="p_group_view", noauthz="app_user:private")
    if context["redirect"]:
        return redirect(context["redirect"])
    aaa = context["aaa"]
...
def edit(request, gid=None, keyname=None):
    ...
    context = start_view(request, app="user", view="group.edit", 
        noauth="app_user:private", perm="p_group_cud", noauthz="app_sirene:index")
    if context["redirect"]:
        return redirect(context["redirect"])
    aaa = context["aaa"]
