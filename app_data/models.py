...
# ----------------------------------------------------------------------------------
# DataStatic / DataStaticValue
# ----------------------------------------------------------------------------------

# DataStaticValue
# - staticname FK => DataStatic:keyname    "CityList"
# - value (str)                            "Paris", "Madrid", "Roma", ...
# - order (int)
# => unique staticname + value



STATIC_FORMAT_CHOICE = (
    ("string", "string"),
    ("int", "int"),
    ("float", "float"),
)
...
class DataStatic(models.Model):
    ...
    dataformat = models.CharField(choices=STATIC_FORMAT_CHOICE, max_length=32, default="string")

    class Meta:
        #db_table = "{{ app_name}}_category"
        ordering = ['keyname']
        verbose_name = "Sirene Data Static Class"
        verbose_name_plural = "Sirene Data Static Classes"
...
class DataStaticValue(models.Model):

    datastatic = models.ForeignKey("DataStatic", null=False, blank=False, on_delete=models.CASCADE)
    value = models.CharField(max_length=2500,  null=True, blank=True)
    ...
    class Meta:
        ...
        verbose_name = "Sirene Data Static Value"
        verbose_name_plural = "Sirene Data Static Values"
