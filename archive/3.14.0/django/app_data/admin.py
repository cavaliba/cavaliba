...
#from app_data.models import DataLink
...
# @admin.register(DataLink)
# class DataLinkAdmin(admin.ModelAdmin):
#    list_display = ('classname1', 'instance1','classname2', 'instance2')
#    ordering=["classname1","classname2"]
#    list_filter = ["classname1", "classname2"]
