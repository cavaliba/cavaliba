...
CELERY_BROKER_URL = os.environ.get("DJANGO_CELERY_BROKER_URL", default="redis://cavaliba_redis:6379")
CELERY_RESULT_BACKEND = os.environ.get("DJANGO_CELERY_RESULT_BACKEND", default="redis://cavaliba_redis:6379")
