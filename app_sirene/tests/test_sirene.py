...
class AppSireneAnonymousTest(TestCase):
    ...
    def setUpTestData(cls):
        ...
        # force mode
        conf = SireneConfiguration.objects.get(appname="user", keyname="AUTH_MODE")
        conf.value = "basic"
        conf.save()

        conf = SireneConfiguration.objects.get(appname="user", keyname="DEBUG_AAA")
        conf.value = "no"
        conf.save()
    ...
    def test_trusted_ip(self):
        conf = SireneConfiguration.objects.get(appname="user",keyname="TRUSTED_ANONYMOUS_IPS")
...
class AppSireneSysadminTest(TestCase):
    ...
    def setUpTestData(cls):
        ...
        conf = SireneConfiguration.objects.get(appname="user", keyname="AUTH_MODE_FORCE_USER")
        conf.value = "sysadmin"
        conf.save()
    ...
    def test_conf_no_skip_public(self):
        r = SireneConfiguration.objects.get(appname="sirene", keyname="PUBLIC_SKIP_TO_TRUSTED")
        self.assertEqual(r.value, 'no')
